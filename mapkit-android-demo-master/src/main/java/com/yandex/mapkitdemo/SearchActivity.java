...
public class SearchActivity extends Activity implements Session.SearchListener, CameraListener {
     ...
     */
    private final String MAPKIT_API_KEY = "e69bcf91-56cc-4089-a5b5-2a0cba171c2c";
    ...
    public void onSearchResponse(Response response) {
        ...
        for (GeoObjectCollection.Item searchResult : response.getCollection().get(0).getChildren())
            {    Point result = searchResult.getObj().getGeometry().get(0).getPoint();
                mapView.getMap().move(
                        new CameraPosition(result, 14.0f, 0.0f, 0.0f),
